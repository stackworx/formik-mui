...
export declare const fieldToSelect: ({ field, form: { isSubmitting }, disabled, ...props }: SelectProps) => {
    ...
    onKeyDown?: ((event: React.KeyboardEvent<HTMLInputElement | HTMLTextAreaElement>) => void) | undefined;
    ...
    onKeyUp?: ((event: React.KeyboardEvent<HTMLInputElement | HTMLTextAreaElement>) => void) | undefined;
